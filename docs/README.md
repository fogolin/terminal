...
2. [Package Authoring (External)](https://github.com/fogolin/firelin-registry/blob/main/docs/README.md): How to build and distribute custom commands for **Firelin Terminal**.
